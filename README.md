...
## **Note: My best code is on GitLab, where I work on production-level projects that pay the bills. These GitHub repositories reflect my journey, but they do not represent my latest skill set.**
